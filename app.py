...
porta_serial = "COM3"  # Exemplo de porta serial, ajuste para o seu caso
...
with open("dados_2300RPM.csv", mode="w", newline="") as arquivo_csv:
    csv_writer = csv.writer(arquivo_csv)
    csv_writer.writerow(["Tempo (s)", "RPM"])
